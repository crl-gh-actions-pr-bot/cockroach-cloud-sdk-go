...
- Update role management operations (AddUserToRole, GetAllRolesForUser, RemoveUserFromRole, SetRolesForUser) to support groups in addition to users and service accounts.
